...
class AdvertisementController extends BackendController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Advertisement']))
		{
            ...
            $banner = CUploadedFile::getInstances($model, 'banner');
            ImagesHelper::processAdvertisement($model, $banner);

			if($model->save())
            {
                $videos = CUploadedFile::getInstancesByName('youtube');
                YoutubeHelper::processAdvertisement($model, $videos);
