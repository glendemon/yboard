...
return array(
	...
	'Please activate you account go to {activation_url}' => 'Вы успешно зарегистрировались на сайте {site_name}. <br />Ваш логин: <b>{username}</b><br />Ваш пароль:<b>{password}</b><br /><span style="color:red;">Для активации аккаунта пожалуйста перейдите по следующей ссылке <b>{activation_url}</b></span>',
