                                    ...
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-left bg-themesecondary">
                                            <div class="databox-piechart">
                                                <div style="width: 47px; height: 47px; line-height: 47px;" data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff" data-linecap="butt" data-percent="50" data-animate="500" data-linewidth="3" data-size="47" data-trackcolor="rgba(255,255,255,0.1)"><span class="white font-90">50%</span><canvas width="47" height="47"></canvas><canvas width="47" height="47"></canvas></div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-left bg-themethirdcolor">
                                            <div class="databox-piechart">
                                                <div style="width: 47px; height: 47px; line-height: 47px;" data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff" data-linecap="butt" data-percent="15" data-animate="500" data-linewidth="3" data-size="47" data-trackcolor="rgba(255,255,255,0.2)"><span class="white font-90">15%</span><canvas width="47" height="47"></canvas><canvas width="47" height="47"></canvas></div>
                                            </div>
                                        </div>
                                        <div class="databox-right">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-left bg-themeprimary">
                                            <div class="databox-piechart">
                                                <div style="width: 47px; height: 47px; line-height: 47px;" id="users-pie" data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff" data-linecap="butt" data-percent="76" data-animate="500" data-linewidth="3" data-size="47" data-trackcolor="rgba(255,255,255,0.1)"><span class="white font-90">76%</span><canvas width="47" height="47"></canvas><canvas width="47" height="47"></canvas></div>
                                            </div>
                                        </div>
                                        <div class="databox-right">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-left no-padding bordered-left-2 bordered-palegreen">
                                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/John-Smith.jpg" style="width:65px; height:65px;">
                                        </div>
                                            ...
                                            <div class="tabbable">
                                                ...
                                                <div class="tab-content tabs-flat no-padding">
                                                    <div id="visits" class="tab-pane active animated fadeInUp">
                                                        <div class="row">
                                                            <div class="col-lg-12 chart-container">
                                                                <div style="padding: 0px; position: relative;" id="dashboard-chart-visits" class="chart chart-lg no-margin"><canvas height="250" width="1043" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 1043px; height: 250px;" class="flot-base"></canvas><div style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);" class="flot-text"><div style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;" class="flot-x-axis flot-x1-axis xAxis x1Axis"><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 5px; text-align: center;">3</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 76px; text-align: center;">4</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 148px; text-align: center;">5</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 219px; text-align: center;">6</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 290px; text-align: center;">7</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 362px; text-align: center;">8</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 433px; text-align: center;">9</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 501px; text-align: center;">10</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 573px; text-align: center;">11</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 644px; text-align: center;">12</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 715px; text-align: center;">13</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 787px; text-align: center;">14</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 858px; text-align: center;">15</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 929px; text-align: center;">16</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 235px; left: 1000px; text-align: center;">17</div></div></div><canvas height="250" width="1043" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 1043px; height: 250px;" class="flot-overlay"></canvas></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="realtime" class="tab-pane padding-left-5 padding-right-10 animated fadeInUp">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div id="dashboard-chart-realtime" class="chart chart-lg no-margin" style="width: 100%; padding: 0px; position: relative;"><canvas height="250" width="100" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 100px; height: 250px;" class="flot-base"></canvas><canvas height="250" width="100" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 100px; height: 250px;" class="flot-overlay"></canvas></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="bandwidth" class="tab-pane padding-10 animated fadeInUp">
                                                        <div class="databox-sparkline bg-themeprimary">
                                                            <span id="dashboard-bandwidth-chart" data-sparkline="compositeline" data-height="250px" data-width="100%" data-linecolor="#fff" data-secondlinecolor="#eee" data-fillcolor="rgba(255,255,255,.1)" data-secondfillcolor="rgba(255,255,255,.25)" data-spotradius="0" data-spotcolor="#fafafa" data-minspotcolor="#fafafa" data-maxspotcolor="#ffce55" data-highlightspotcolor="#fff" data-highlightlinecolor="#fff" data-linewidth="2" data-secondlinewidth="2" data-composite="500, 400, 100, 450, 300, 200, 100, 200"><canvas height="250" width="1023" style="display: inline-block; width: 1023px; height: 250px; vertical-align: top;"></canvas></span>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                                <div class="databox databox-xlg databox-vertical databox-inverted databox-shadowed">
                                                                    <div class="databox-top">
                                                                        <div class="databox-piechart">
                                                                            <div style="width: 125px; height: 125px; line-height: 125px;" data-toggle="easypiechart" class="easyPieChart block-center" data-barcolor="themeprimary" data-linecap="butt" data-percent="80" data-animate="500" data-linewidth="8" data-size="125" data-trackcolor="#eee">
                                                                                <span class="font-200"><i class="fa fa-gift themeprimary"></i></span>
                                                                            <canvas width="125" height="125"></canvas><canvas width="125" height="125"></canvas></div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="databox-bottom no-padding text-align-center">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                                <div class="databox databox-xlg databox-vertical databox-inverted  databox-shadowed">
                                                                    <div class="databox-top">
                                                                        <div class="databox-piechart">
                                                                            <div style="width: 125px; height: 125px; line-height: 125px;" data-toggle="easypiechart" class="easyPieChart block-center" data-barcolor="themethirdcolor" data-linecap="butt" data-percent="40" data-animate="500" data-linewidth="8" data-size="125" data-trackcolor="#eee">
                                        ...
                                        <div class="task-container">
                                            <div class="task-search">
                                                <span class="input-icon">
                                                    <input class="form-control" placeholder="Search Tasks" type="text">
                                                ...
                                                <div class="tickets-container">
                                                    <ul class="tickets-list">
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/adam-jansen.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/divyia.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/Matt-Cheuvront.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/Sergey-Azovskiy.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/John-Smith.jpg" class="user-avatar">
                            ...
                            <div class="databox databox-xxlg databox-vertical databox-inverted">
                                <div class="databox-top bg-whitesmoke no-padding">
                                    ...
                                    <div class="databox-row row-6 no-padding">
                                        <div class="databox-sparkline">
                                            <span data-sparkline="line" data-height="126px" data-width="100%" data-fillcolor="#37c2e2" data-linecolor="#37c2e2" data-spotcolor="#fafafa" data-minspotcolor="#fafafa" data-maxspotcolor="#ffce55" data-highlightspotcolor="#f5f5f5 " data-highlightlinecolor="#f5f5f5" data-linewidth="2" data-spotradius="0"><canvas height="126" width="686" style="display: inline-block; width: 686px; height: 126px; vertical-align: top;"></canvas></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="databox-bottom">
                                    <div class="databox-row row-12">
                                        <div class="databox-cell cell-7 text-center  padding-5">
                                            <div style="padding: 0px; position: relative;" id="dashboard-pie-chart-sources" class="chart"><canvas height="220" width="362" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 362px; height: 220px;" class="flot-base"></canvas><canvas height="220" width="362" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 362px; height: 220px;" class="flot-overlay"></canvas></div>
                                        </div>
