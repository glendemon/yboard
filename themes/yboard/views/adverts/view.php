        ...
        <thead>
            <tr><th colspan="2" class="alert-info">
				...
				<div style='font-size:12px;'>
					<i class='fa fa-user'></i><?php echo CHtml::link(CHtml::encode($model->user->username), array('user/user/view', 'id' => $model->user->id)); ?>  
					<div id='owner-info' style='display:none'> 
						<?php echo CHtml::encode($model->user->profile->getAttributeLabel('company')); ?>:
						<?php echo CHtml::encode($model->user->profile->company); ?>
						 <?php echo CHtml::link(Yii::t('bulletin', 'Send a mail to the author'), array('site/contact', 'id' => $model->user->id)); ?>
						<?php echo CHtml::encode($model->user->profile->city); ?>
						<?php echo CHtml::encode($model->user->profile->phone); ?>
						<?php echo CHtml::encode($model->user->profile->url); ?>
					</div>
