                                    ...
                                    <tr class="hero-unit">
                                        <td class="image">
                                            <?php if ($category->icon): ?>
                                                <img src="<?php echo Yii::app()->request->baseUrl.CHtml::encode($category->icon); ?>" />
                <?php endif; ?>
                                        </td>
                                        <td>
                                            <a href="<?php echo Yii::app()->createUrl('site/category', 
                                        ...
                                        <td>
                                            <span class="label label-info">
                                                <?php echo $category->countBulletins() ? '' . $category->countBulletins() . '' : ''; ?>
                                            </span> 
                                        </td>
                                    </tr>
                    ...
                    <?php endif; ?>
                                                <a href="<?php echo Yii::app()->createUrl('site/category', 
                                                        array('id' => $subcategory->id)); ?>">
                                                            <?php echo CHtml::encode($subcategory->name); ?>
                                                </a>
                                            </td>
                                            <td>
                                                <span class="label label-info">
                                                    <?php echo $subcategory->countBulletins() ? '' . $subcategory->countBulletins() . '' : ''; ?>
                                                </span>
                                            </td>
                                        </tr>
                                <?php endforeach; ?>
