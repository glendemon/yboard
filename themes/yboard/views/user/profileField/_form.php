<div class="form">
    ...
    <div class="row varname">
        ...
        <?php echo (($model->id) 
            ? CHtml::activeTextField($model, 'varname', array(
        ...
        <p class="hint"><?php echo t("Allowed lowercase letters and digits."); ?></p>
    </div>
    ...
    <div class="row title">
        ...
        <p class="hint"><?php echo t('Field name on the language of "sourceLanguage".'); ?></p>
    </div>

    <div class="row field_type">
        <?php echo CHtml::activeLabelEx($model, 'field_type'); ?>
        <?php echo (($model->id) ? CHtml::activeTextField($model, 'field_type', 
                array('size' => 60, 'maxlength' => 50, 'readonly' => true, 
                    'id' => 'field_type'
                )) 
                : CHtml::activeDropDownList($model, 'field_type', 
                ProfileField::itemAlias('field_type'), array('id' => 'field_type'))); ?>
        <?php echo CHtml::error($model, 'field_type'); ?>
        <p class="hint"><?php echo t('Field type column in the database.'); ?></p>
    </div>

    <div class="row field_size">
        <?php echo CHtml::activeLabelEx($model, 'field_size'); ?>
        <?php echo (($model->id) ? CHtml::activeTextField($model, 'field_size', 
                array('readonly' => true)) : CHtml::activeTextField($model, 'field_size')); ?>
        <?php echo CHtml::error($model, 'field_size'); ?>
        <p class="hint"><?php echo t('Field size column in the database.'); ?></p>
    </div>
    ...
    <div class="row field_size_min">
        ...
        <p class="hint"><?php echo t('The minimum value of the field (form validator).'); ?></p>
    </div>
    ...
    <div class="row required">
        ...
        <p class="hint"><?php echo t('Required field (form validator).'); ?></p>
    </div>
    ...
    <div class="row match">
        ...
        <p class="hint"><?php echo t("Regular expression (example: '/^[A-Za-z0-9\s,]+$/u')."); ?></p>
    </div>
    ...
    <div class="row range">
        ...
        <p class="hint"><?php echo t('Predefined values (example: 1;2;3;4;5 or 1==One;2==Two;3==Three;4==Four;5==Five).'); ?></p>
    </div>
    ...
    <div class="row error_message">
        ...
        <p class="hint"><?php echo t('Error message when you validate the form.'); ?></p>
    </div>
    ...
    <div class="row other_validator">
        ...
        <p class="hint"><?php echo t('JSON string (example: {example}).', array('{example}' => CJavaScript::jsonEncode(array('file' => array('types' => 'jpg, gif, png'))))); ?></p>
    </div>
    ...
    <div class="row default">
        ...
        <p class="hint"><?php echo t('The value of the default field (database).'); ?></p>
    </div>
...
<?php echo CHtml::error($model, 'widget'); ?>
        <p class="hint"><?php echo t('Widget name.'); ?></p>
    </div>
...
<?php echo CHtml::error($model, 'widgetparams'); ?>
        <p class="hint"><?php echo t('JSON string (example: {example}).', array('{example}' => CJavaScript::jsonEncode(array('param1' => array('val1', 'val2'), 'param2' => array('k1' => 'v1', 'k2' => 'v2'))))); ?></p>
    </div>
...
<?php echo CHtml::error($model, 'position'); ?>
        <p class="hint"><?php echo t('Display order of fields.'); ?></p>
    </div>
...
<div id="dialog-form" title="<?php echo t('Widget parametrs'); ?>">
    <form>
        <fieldset>
