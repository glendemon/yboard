...
?>
<div class='userHead'>
    <h4><? echo $model->username; ?></h4> <? if($model->lastvisit_at){?>(<?=PeopleDate::format($model->lastvisit_at)?>)<? } ?>
...
<div> 
    ...
    <?php echo $this->renderPartial('/messages/_form', array('model'=>$mes_model, 'receiver'=>$userData->id)); ?>
